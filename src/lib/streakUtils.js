...
// ─────────────────────────────────────────────
// recalculateStreak
// Recalculates and persists the PER-HABIT streak to IndexedDB.
...
// Async wrapper for the Dashboard StreakBadge (reads IndexedDB).
// Returns the current overall streak number (for backward compat).
// ─────────────────────────────────────────────
